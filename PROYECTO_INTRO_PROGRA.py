...
def agregar_inst(codigo_inst):
   ...
   if reutilizable.lower() == "si":
      ...
      instrumentos[codigo_inst] = [instrumento, stock_min, total, unidad, disponibilidad]
   if reutilizable.lower()== "no":
      instrumentos[codigo_inst] = [instrumento, stock_min, total, unidad]
...
def agregar_disp(codigo_disp):
   ...
   stock_min = int(input(f"Ingrese la cantidad mínima de disponibilidad de {unidad}: "))
   dispositivos[codigo_disp] = [dispositivo, stock_min, total, unidad,disponibilidad]
         ...
         while op3 !=0:
            ...
            match op3:
               case 1:
                  ...
                  if codigo_med in medicamentos:
                     cantidad = int(input(f"Ingrese la cantidad de devoluvión de {medicamentos[codigo_med][3]} que ingresa: "))
               ...
               case 2:
                  ...
                  if codigo_inst in instrumentos:
                     if deseo==1:
                        cantidad = int(input(f"Ingrese la cantidad de devoluvión de {instrumentos[codigo_inst][3]} que ingresa: "))
               ...
               case 3:
                  ...
                  if codigo_disp in dispositivos:
                     if deseo==1:
                        cantidad = int(input(f"Ingrese la cantidad de devoluvión de {dispositivos[codigo_disp][3]} que ingresa: "))
            ...
            match op6:
               ...
               case 3:
                  ...
                  if papelera in dispositivos:
                     ...
                     baja = int(input("¿Cuántas unidades se dañaron/perdieron definitivamente?: "))
                     dispositivos[papelera][2] -= baja # Resta de disponible
